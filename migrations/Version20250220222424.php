 ...
 */
final class Version20250220222424 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart (cart_id INT AUTO_INCREMENT NOT NULL, album_id VARCHAR(255) NOT NULL, album_image VARCHAR(255) NOT NULL, album_title VARCHAR(255) NOT NULL, artist_name VARCHAR(255) NOT NULL, type VARCHAR(20) NOT NULL, quantity INT DEFAULT 1 NOT NULL, total_price INT DEFAULT 0 NOT NULL, added_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, user_id INT NOT NULL, INDEX IDX_BA388B7A76ED395 (user_id), PRIMARY KEY(cart_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
